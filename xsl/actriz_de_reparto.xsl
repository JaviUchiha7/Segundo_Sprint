				...
				<main>
					...
					<nav class="menu_principal">
						...
						<ul>
							...
							<li><a href="actor_de_reparto.xml">Actor de reparto</a></li>
							<li><a href="actriz_de_reparto.xml">Actriz de reparto</a></li>
							<li><a href="externo.xml">xml externo</a></li>
							<li><a href="../html/formulario.html">Votaciones mejor pelicula</a></li>
						</ul>
					</nav>
					<xsl:for-each select="Actor_de_reparto/Actor">
						<div class="enlaces">
							<li>
								<h2>
